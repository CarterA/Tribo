...
- (NSString *)passwordFromKeychain {
	...
	NSString *protocolString = [self.site.metadata objectForKey:TBSiteProtocolKey];
	SecProtocolType protocol = 0;
	if ([protocolString isEqualToString:TBSiteProtocolFTP])
		protocol = kSecProtocolTypeFTP;
	else if ([protocolString isEqualToString:TBSiteProtocolSFTP])
